...
def getOwnTrustObject(persp_dir, idx, entity_id):
...
def createTrustObjects(persp_dir, idx, entity_id, detections, results):
    trust_detections = []

    # Add ego object (self)
    ego_tDet = getOwnTrustObject(persp_dir, idx, entity_id)
